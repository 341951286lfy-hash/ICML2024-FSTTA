...
def parse_args():
    parser = argparse.ArgumentParser(
        description="REVERIE parser for FSTTA + NavTrust-style RGB feature banks"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='override args.img_ft_file with a precomputed corrupted panorama hdf5 file',
    )
    parser.add_argument(
        '--rgb_corrupt_type',
        type=str,
    ...
    parser.add_argument('--optim', type=str, default='adamW', choices=['rms', 'adam', 'adamW', 'sgd'])
    ...
    parser.add_argument('--TTA_lr', default=0.064 / 64, type=float, help='TTA learning rate')
...
def postprocess_args(args):
    ...
    args.img_ft_file = args.rgb_feat_file if args.rgb_feat_file is not None else default_img_ft_file
