...
def parse_args():
    parser = argparse.ArgumentParser(description="REVERIE parser for FSTTA + NavTrust-style RGB feature banks")
    ...
    # NavTrust-style corrupted panorama feature bank
    ...
    # legacy FSTTA args kept for compatibility
